...
public class NetworkMain {
    ...
    public void registry() {
        ...
        network.registerMessage(PacketOpenHudConfig.Handler.class, PacketOpenHudConfig.class, packetId++, Side.CLIENT);
        ...
        network.registerMessage(
            ...
            Side.CLIENT);
        network.registerMessage(
            com.czqwq.EZMiner.chain.network.PacketMinesweeperClear.Handler.class,
        ...
        network.registerMessage(
            ...
            Side.CLIENT);
        network.registerMessage(
            com.czqwq.EZMiner.chain.network.PacketProspectState.Handler.class,
            com.czqwq.EZMiner.chain.network.PacketProspectState.class,
            packetId++,
            Side.CLIENT);
